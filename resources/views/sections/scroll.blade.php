<div class="scroll-up-curve">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 80">
        <path fill="#BEE5F5" fill-opacity="1" d="M0,0 C0,80 1120,-90 1600,80 L1440,90 L0,90 Z">
        </path>
    </svg>
</div>
<div class="scroll">
    ...
    <div class="scroll-container">
        ...
        <div class="section last-section">
            ...
            <div class="bottom-section">
                <svg width="120px" height="120px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="12" cy="12" r="10" stroke="#BEE5F5" stroke-width="0.5" />
                    <path
...
<div class="scroll-bottom-curve">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 80">
        <path fill="#BEE5F5" fill-opacity="1" d="M0,0 C320,20 1120,80 1440,20 L1440,80 L0,80 Z">
        </path>
    </svg>
</div>
